...
import com.github.polyrocketmatt.pencil.engine.gui.action.InventoryAction;
...
public class CustomInventory implements AbstractInventory {
    ...
    private final Map<Integer, InventoryAction> actionMap;
     ...
     * @param id            the id
     */
    public CustomInventory(Map<Integer, InventoryAction> actionMap, Inventory inventory, String name, int rows, int columns, int id) {
     ...
     */
    public Map<Integer, InventoryAction> getActionMap() {
        return actionMap;
    }
